...
int main()
{
    ...
    LinkedList* listaFiltradaMayor500 = NULL;
    LinkedList* listaFiltradaMenor500 = NULL;
    ...
    do {
    	...
    	case 2:
    		if(flagDatos == 1){
    			...
    			printf("\nAntes de poder mostrar la lista, debe cargar la lista con datos desde el archivo.");
    		}
    		printf("\n\n");
    		system("pause");
    		break;
    	...
    	case 4:
    		if(flagDatos == 1 && flagMap == 0){
    			...
    			printf("\nNo se pueden aplicar descuentos a una lista con descuentos previamente aplicados");
    		}
    		else{

    			printf("\nPrimero se deben cargar los datos desde el archivo al sistema, antes de poder aplicarle los descuentos");
    		}
    		printf("\n\n");
    		system("pause");
    		break;
    	...
    	case 6:
    		if(flagDatos == 1 && flagMap == 0){
    			...
    			printf("\nLas listas filtradas solo pueden ser obtenidas del archivo 'Datos.csv', sin aplicacion de descuentos.");
