 ...
 * \return int Retorna 0 : si la lista es NULL
 * 					   1 : si tuvo exito.
*/
...
/** \brief Abre el archivo en modo escritura, valida que no sea NULL, llama a la funcione de escritura y cierra el archivo.
 *
 * \param pList LinkedList* Puntero a la lista.
 * \param from char* path path del archivo que se va a leer.
 * \return int Retorna 0 : si la lista es NULL
